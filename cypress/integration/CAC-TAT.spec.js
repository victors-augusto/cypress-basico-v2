...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('exibe mensagem de erro quando o telefone se torna obrigatório mas não é preenchido', function() {
        ...
        cy.get('#lastName').type('Augusto')
        cy.get('#email').type('teste@teste.com')
        cy.get('#phone-checkbox').check() //cy.get('#phone-checkbox').click()
        cy.get('#open-text-area').type('Teste')
        //cy.get('button[type="submit"]').click()
        cy.contains('button', 'Enviar').click()
        ...
        it('marca ambos checkboxes, depois desmarca o último', function() {
         ...
         //MD 8 - Exercício extra 1
         //it('acessa a página da política de privacidade removendo o target e então clicando no link', function() {
            // cy.get('#privacy a').click() - Ver o click e aba aberta na nova aba
         //   cy.get('#privacy a')
